...
like disability status and region are linked to student dropout and academic 
performance, with the aim of helping course teams identify at-risk student 
groups early and provide targeted support.
...
3. *(Coming next)* Does gender or age group affect outcomes?
4. *(Coming next)* Can early engagement (VLE clicks) predict which students will withdraw?
...
## Status
🚧 In progress — next steps are analyzing gender/age, adding Python-based 
